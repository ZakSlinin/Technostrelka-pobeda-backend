...
resource = cors.add(app.router.add_resource("/api/subscriptions/update/{id}"))
cors.add(resource.add_route("PATCH", handlers.update_subscription_handler))
resource = cors.add(app.router.add_resource("/api/subscriptions/delete/{id}"))
cors.add(resource.add_route("DELETE", handlers.delete_subscription_handler))
resource = cors.add(app.router.add_resource("/api/subscriptions/all"))
cors.add(resource.add_route("GET", handlers.get_subscription_handler))
resource = cors.add(app.router.add_resource("/uploads/{file}"))
cors.add(resource.add_route("GET", handlers.get_subavatar_handler))
resource = cors.add(app.router.add_resource("/api/subscriptions/{id}"))
cors.add(resource.add_route("GET", handlers.getid_subscription_handler))
